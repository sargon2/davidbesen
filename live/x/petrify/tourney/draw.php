<?
	...
	if($nodraw!=1) Header("Content-type: image/jpg");
	...
	$result = mysql_query("select max(position), max(level) from TOURNEY_users where game=$game");
	print mysql_error();
